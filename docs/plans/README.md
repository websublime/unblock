...
| `unblock-mcp` | ● 8 tools (D37 added `comment` at T3.9 — RK-3 budget FULL) + resources + prompts + server | ● discriminator growth + coordination resource | ◐ sync_status resource (feature) | ◐ batch/streaming/changes |
