...
| [`crates/unblock-mcp.md`](crates/unblock-mcp.md) | L7 (PRIMARY). rmcp 1.7 stdio server — 8-tool taxonomy + resources + prompts, quota-checked and strictly deserialized, `contract_version`-stamped. Thin adapter over `Session`. |
