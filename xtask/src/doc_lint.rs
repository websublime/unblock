...
struct CorpusIndex {
    /// D-ids defined in PRD §4 (`| **Dx** |` rows), e.g. {1..=30}.
...
fn class_a_d_ids(doc: &Doc, guards: &Guards, index: &CorpusIndex, out: &mut Vec<Finding>) {
    // Spec tokenizes `\bD(51|50|49|48|47|46|45|44|43|42|41|40|39|38|37|36|35|34|33|32|31|30|2[0-9]|1[0-9]|[1-9])\b` for the in-range ids (D1..D51), but an undefined ref
...
const CANONICAL_VERBS: &[&str] = &[
    "mcp", "migrate", "doctor", "version", "init", "agents", "update",
];
