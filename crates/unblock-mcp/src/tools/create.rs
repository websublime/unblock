...
//! fields (Priority, `StoryPoints`, `DeferUntil`, Status=Backlog — the
//! create-time default per spec §8.3 / `unblock-1zj`; Backlog is sticky and
//! the user/agent must explicitly transition out via `update`/`claim`),
