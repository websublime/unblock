...
The contract id is **`unblock.mcp.v1.6`**. For machine-readable discovery, agents read the resources
...
The contract (`unblock.mcp.v1.6`) exposes **8 tools**, **5 resources**, and **3 prompts**.
