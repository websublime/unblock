// db.go declares the package-level *sqldb.Database handle for the deps
...
// `go test ./apps/api/deps/...` outside the encore CLI with the
...
// infrastructure. The deps package still owns `db`; the db service
