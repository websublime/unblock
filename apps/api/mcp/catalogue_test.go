...
// expectedP01ToolNames mirrors SPEC.md §5.2.2 (14 P01 tools) in the
...
// TestCataloguePxxToolCount pins AC #1 first half: exactly 14 entries
// in tools[]. A 15th tool means either P02 has shipped (in which case
